	...
	<form action="<?= base_url('panel/aviones/agregar');?>" method="post" class="frm_addmod">
		<div class="frmsec-left w60 f-l">
			...
			<p class="f-l w50">
				...
				<input type="text" name="dfecha_vence_tarjeta" id="dfecha_vence_tarjeta" value="<?= set_value('dfecha_vence_tarjeta') ?>" size="30" maxlength="10">
			</p>
			<p class="f-l w100">
				<label for="dfecha_vence_seguro">*Fecha vencimiento seguro</label><br>
				<input type="text" name="dfecha_vence_seguro" id="dfecha_vence_seguro" value="<?= set_value('dfecha_vence_seguro') ?>" size="30" maxlength="10">
			</p>
