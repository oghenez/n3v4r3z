	...
	<form action="" method="post" class="frm_addmod">
		<div class="frmsec-left w80 f-l b-r">
				<div class="corner-all">
					<p class="w40 f-l">
						...
						<input type="text" name="dfolio" id="dfolio" value="<?= isset($info[1]['cliente_info'][0]->folio) ?$info[1]['cliente_info'][0]->folio:'';?>"readonly>
					</p>
					<div class="clear"></div>
					<p class="w100">
					...
					<table class="tblListados corner-all8 f-r" style="width:24% !important;margin-right:1%;text-align:center;">
						<tr>
							...
							<td id="ta_subtotal" class="w20 a-r" style="background-color:#ccc;"><?= String::formatoNumero($info[1]['cliente_info'][0]->subtotal); ?></td>
						</tr>
						<tr>
							<td style="text-align:right;">IVA</td>
							<td id="ta_iva" class="a-r" style="background-color:#ccc;"><?= String::formatoNumero($info[1]['cliente_info'][0]->iva); ?></td>
						</tr>
						<tr>
							<td style="text-align:right;">Total</td>
							<td id="ta_total" class="a-r" style="background-color:#ccc;"><?= String::formatoNumero($info[1]['cliente_info'][0]->total); ?></td>
						</tr>
					</table>
		...
		<div class="frmsec-right w20 f-l">
			<div class="frmbox-r p5-tb corner-right8">
				...
				<input type="text" name="dfecha" id="dfecha" value="<?= isset($info[1]['cliente_info'][0]->fecha) ?$info[1]['cliente_info'][0]->fecha:''; ?>" class="a-c" size="15" readonly>
				
				<p class="w100 f-l">
						<label for="dtipo_pago">*Tipo de Pago</label> <br>
						<select name="dtipo_pago" id="dtipo_pago" disabled>
							<option value="credito" <?= set_select('dtipo_pago', 'credito', false,$info[1]['cliente_info'][0]->tipo_pago); ?>>Crédito</option>
							<option value="contado" <?= set_select('dtipo_pago', 'contado', false,$info[1]['cliente_info'][0]->tipo_pago); ?>>Contado</option>
						</select>
				</p>
				<div class="clear"></div>
			</div>
