...
<div>
	...
	<form action="<?= base_url('panel/facturacion/pagar/?'.String::getVarsLink(array('msg')));?>" method="post">
		<div class="frmsec-left w90 f-l">
			...
			<p class="f-l w100">
				...
				<textarea name="fconcepto" rows="4" cols="53" autofocus><?= set_value('fconcepto')!='' ? set_value('fconcepto') : "Pago total de la Factura ({$serie}-{$folio})" ; ?></textarea>
			</p>
